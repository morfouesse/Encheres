...
public class TestDal {
	...
	public static void main(String args[]) {
		...
		//Utilisateur utilisateur3 = new Utilisateur("pseudo3", "nom3", "prenom3", "email3@domaine.com", "0123333333", "rue3", "33333", "ville3", "mdp3", 40, false);
		...
		DaoFactory.getArticleVenduDao().insertArticleVendu(articleVendu1);
