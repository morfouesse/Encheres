...
<c:import url="navigation.jsp" />
	...
	<form action="${pageContext.request.contextPath}/ServletNouvelleVente" method="post">
	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="form-group col-md-12" style="text-align:center;">
				...
				<a href="${pageContext.request.contextPath}/ServletAccueil"><button type="submit" class="btn btn-primary"
